...
from app.schemas.maps import MapsObjectsResponseSchema, MapResponseSchema
from app.services.maps import MapService

router = APIRouter(prefix="/map", tags=["Map"])


@router.get("/", response_model=list[MapResponseSchema])
async def get_maps(
...
@router.get("/{map_id}", response_model=MapsObjectsResponseSchema)
